...
original=nzQuery('SELECT * FROM DIGITAL_RETAIL_ANALYSIS..RH_ECOM_SHOPPER_CLUSTER_DATASET where PAGE_VIEWS is not null and PAGE_VIEWS <= 200 and ORDERS in (0,1) and CHECKOUT < 20 order by RANDOM() limit 1000000')
#Change var types
